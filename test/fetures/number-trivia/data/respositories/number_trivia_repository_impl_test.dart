...
main() {
  ...
  group('getConcreteNumberTrivia', () {
    ...
    runTestOnline(() {
      ...
      test(
          'should  chache data locally when the call to remote data source is successful',
          () async {
        //arrange
        when(mockRemoteDataSource.getConcreateNumberTrivia(any))
            .thenAnswer((_) async => tNumberTriviaModel);
    ...
    runTestOffline(() {
      test('should last locally cached data when the chached data is present',
          () async {
        //arrange
      ...
      test(
          'should return CacheFailure cached data when no chached data is present',
          () async {
        //arrange
        when(mockLocalDataSource.getLastNumberTrivia())
